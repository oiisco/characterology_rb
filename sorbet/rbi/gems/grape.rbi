...
class Grape::Router
  ...
  def call(env); end
  def call_with_allow_headers(env, methods, endpoint); end
...
class Grape::Router::Any < Grape::Router::AttributeTranslator
  def index; end
  def initialize(pattern, regexp, index, **attributes); end
  def pattern; end
  def regexp; end
end
class Grape::Router::NormalizePathCache < Grape::Util::Cache
  def initialize; end
end
...
module Grape::DSL::Settings
  ...
  def within_namespace(&_block); end
  extend ActiveSupport::Concern
end
...
module Grape::DSL::Helpers::ClassMethods
  ...
  def inject_api_helpers_to_mod(mod, &_block); end
...
class Grape::Validations::Base
  def attrs; end
  def fail_fast?; end
  def initialize(attrs, options, required, scope, opts = nil); end
...
class Grape::Validations::AllowBlankValidator < Grape::Validations::Base
  def validate_param!(attr_name, params); end
end
class Grape::Validations::AsValidator < Grape::Validations::Base
  def initialize(attrs, options, required, scope, opts = nil); end
  def validate_param!(attr_name, params); end
end
class Grape::Validations::MultipleParamsBase < Grape::Validations::Base
  def all_keys; end
  def keys_in_common(resource_params); end
  def validate!(params); end
end
class Grape::Validations::AtLeastOneOfValidator < Grape::Validations::MultipleParamsBase
  def validate_params!(params); end
end
class Grape::API::Boolean
  def self.build(val); end
end
class Grape::Validations::CoerceValidator < Grape::Validations::Base
  ...
  def validate(request); end
  def validate_param!(attr_name, params); end
  def validation_exception(attr_name); end
end
class Grape::Validations::DefaultValidator < Grape::Validations::Base
...
class Grape::Validations::ExactlyOneOfValidator < Grape::Validations::MultipleParamsBase
  def validate_params!(params); end
end
class Grape::Validations::MutualExclusionValidator < Grape::Validations::MultipleParamsBase
  def validate_params!(params); end
end
class Grape::Validations::PresenceValidator < Grape::Validations::Base
  def validate_param!(attr_name, params); end
end
class Grape::Validations::RegexpValidator < Grape::Validations::Base
  def validate_param!(attr_name, params); end
end
class Grape::Validations::SameAsValidator < Grape::Validations::Base
  def build_message; end
  def validate_param!(attr_name, params); end
end
class Grape::Validations::ValuesValidator < Grape::Validations::Base
...
class Grape::Validations::ExceptValuesValidator < Grape::Validations::Base
  def initialize(attrs, options, required, scope, opts = nil); end
  def validate_param!(attr_name, params); end
end
module Grape::DSL::Parameters
  ...
  def map_params(params, element); end
...
class Grape::Validations::AllOrNoneOfValidator < Grape::Validations::MultipleParamsBase
  def validate_params!(params); end
end
module DryTypes
  extend Anonymous_Dry_Core_Deprecations_Tagged_29
  extend Anonymous_Module_30
  extend Dry::Core::Deprecations::Interface
  extend Dry::Types::BuilderMethods
  include Anonymous_Dry_Types_Module_31
end
module DryTypes::Definition
end
module Anonymous_Dry_Types_Module_31
  def self.included(base); end
  extend Dry::Types::BuilderMethods
end
module Anonymous_Dry_Core_Deprecations_Tagged_29
end
...
class Grape::Validations::Types::SetCoercer < Grape::Validations::Types::DryTypeCoercer
  def call(value); end
  def coerce_elements(collection); end
  def initialize(type, strict = nil); end
end
...
module Grape::DSL::InsideRoute::PostBeforeFilter
  def declared(passed_params, options = nil, declared_params = nil); end
  def declared_array(passed_params, options, declared_params); end
  def declared_hash(passed_params, options, declared_params); end
  def declared_param_is_array?(declared_param); end
  def handle_passed_param(declared_param, passed_children_params, &_block); end
  def optioned_declared_params(**options); end
  def optioned_param_key(declared_param, options); end
  def route_options_params; end
  def should_be_empty_array?(declared_param, passed_children_params); end
end
