...
module Dry::Types::Type
  ...
  extend Anonymous_Dry_Core_Deprecations_Tagged_43
  extend Dry::Core::Deprecations::Interface
end
module Anonymous_Dry_Core_Deprecations_Tagged_43
end
